class Fukuoka < ApplicationRecord
  require 'mechanize'

  def self.fukuoka_scrape(params)
    agent = Mechanize.new
    page = agent.get('https://www.tvkingdom.jp/chart/55.action?head=&span=24&chartWidth=950&cellHeight=3&sticky=false&descriptive=true&buttonType=0')
